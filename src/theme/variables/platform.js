...
export default {
  ...
  platform,
    ...
    // Header
    primaryColor: '#0B3A42',//"#3B5A94",
    secondaryColor:'#629aa9',//'#293F68',
    toolbarBottomBg: '#0B3A42',//"#3B5A94",
    lightGreen: '#e6ffe6',

    toolbarBtnColor: platform === "ios" ? "#007aff" : "#fff",
    toolbarHeight: platform === "ios" ?  58 : 50,//64 : 56,
    toolbarIconSize: platform === "ios" ? 20 : 22,
    toolbarSearchIconSize: platform === "ios" ? 20 : 23,
    toolbarInputColor: platform === "ios" ? "#CECDD2" : "#fff",
    searchBarHeight: platform === "ios" ?  26 : 34,  //30:40
    toolbarInverseBg: "#222",
    toolbarTextColor: platform === "ios" ? "#000" : "#fff",
    toolbarDefaultBorder: platform === "ios" ? "#a7a6ab" : "#3F51B5",
    iosStatusbar: "light-content",
    get statusBarColor() {
      return color(this.primaryColor).darken(0.2).hex();
    },
