...
const titles = ['welcome','personal','contact','experience','validatePhone', 'profilePic', 'tos']
  ...
  render() {
    ...
    return (
      <Container style={styles.background}>
        ...
        {flowPage > 0 && (<BlockButton text={flowPage === 6 ? I18n.t('signup.acceptAndFinish') : I18n.t('signup.next')} onPress={() => this.nextBack(true)}/>)}
