...
const en = {
  jobs:{
    ...
    app:{
      ...
      goBack: 'Go Back',
      apply: 'Apply',
      infoWillBeShared1: 'The following information',
      infoWillBeShared2: 'will be shared with the employer:',
      itemsInRed: 'Items in red needs to be completted',
      personalInfo: 'Personal Information',
      career: 'Professional Career',
      completted: 'Completted ',
      appSent: 'Your application was submitted',
      ...
      sendMsg: 'Message',
      applied: 'Applied',
      disclosure: '* The employer will be able to call you.'
  },
  applied:{
    title: 'Applied Jobs' ,
